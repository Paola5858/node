...
function ImageCapture({ tipo, label, required, error, onImageChange }) {
  ...
  function selecionarFoto(event) {
    ...
    leitor.onload = () => onImageChange(leitor.result)
  ...
  function capturarFoto() {
    ...
    canvas.toBlob((blob) => {
      ...
      setErroCamera('')
      onImageChange(canvas.toDataURL('image/jpeg', .9))
      pararCamera()
    }, 'image/jpeg', .9)
  }
